...
export default function Main(){
	return(
		<>
			<SEO 
				title="Главная" 
				description="Проммедь - ведущий поставщик кабельной продукции. Широкий ассортимент кабелей, проводов и электротехнических товаров по выгодным ценам с доставкой по всей России."
